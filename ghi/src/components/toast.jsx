...
const ToastComponent = ({ message, duration = 3000, onClose, showConfirm = false, onConfirm}) => {
    useEffect(() => {
        if (!showConfirm) {
    ...
    return (
        <div className="fixed top-20 right-4 bg-white rounded-lg shadow-lg p-4 text-black duration-500 ease-in-out opacity-100 translate-t-0 animate-bounce z-20 min-w-[200px] text-center">
            <p className="text-sm font-medium">{message}</p>
        </div>
    );
};
